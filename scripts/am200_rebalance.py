...
TARGET_CONSTITUENTS = 200
BUFFER_MULTIPLIER = 1.2

MIN_ADV_USD = 500_000
MIN_TRADING_DAYS_90D = 75
MIN_HISTORY_YEARS = 3
...
OUTPUT_FILE = "output/AM200_history.xlsx"
ADV_USD_FILE = "output/AM200_adv_usd.csv"
CAPACITY_USD_FILE = "output/AM200_capacity_usd.csv"
LIQUIDITY_RANKING_FILE = "output/am200_liquidity_ranking.csv"
LIQUIDITY_REPORT_FILE = "output/am200_liquidity_report.csv"
RANKING_REPORT_FILE = "output/am200_ranking.csv"
UNIVERSE_RANKED_FILE = "output/am200_universe_ranked.csv"
REBALANCE_AUDIT_PATTERN = "output/am200_rebalance_audit_{yyyymm}.csv"
DECISION_AUDIT_FILE = "output/am200_rebalance_decision_audit.csv"
REPORT_FILE = "output/am200_report.txt"
COUNTRY_EXPOSURE_FILE = "output/am200_country_exposure.csv"
...
for selection_date, implementation_date in rebalance_schedule:
    ...
    for col in price_cols:
        ...
        if valid_obs.sum() < MIN_VALID_OBSERVATIONS:
