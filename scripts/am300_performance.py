...
INDEX_NAME = "AM300"
HISTORY_FILE = "output/AM300_history.xlsx"
OUTPUT_FILE = "output/AM300_total_return.csv"
METRICS_FILE = "output/AM300_metrics.csv"
VALIDATION_FILE = "output/AM300_return_validation_report.csv"
